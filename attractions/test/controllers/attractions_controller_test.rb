...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { description: @attraction.description, entry_fee: @attraction.entry_fee, name: @attraction.name, rating: @attraction.rating, web_address: @attraction.web_address }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { description: @attraction.description, entry_fee: @attraction.entry_fee, name: @attraction.name, rating: @attraction.rating, web_address: @attraction.web_address }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
